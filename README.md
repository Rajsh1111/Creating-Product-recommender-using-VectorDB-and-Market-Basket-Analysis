...
We also created product recommender system which is based on content based recommendations and uses prompts in form of queries from end-user to find closest matching available products. It then suggests the same to the customer.
